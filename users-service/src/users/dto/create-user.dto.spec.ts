...
const plain = (
  ...
  const {
    displayName = tests.stringOfLength(Constants.DISPLAY_NAME_MIN_LENGTH),
    email = 'email@example.com',
    password = tests.stringOfLength(Constants.PASSWORD_MIN_LENGTH),
  } = obj;
...
describe('validate CreateUserDto', () => {
  ...
  tests.testDtoValidationForMissingField(CreateUserDto, plain);
